...
function BlueskyIcon(props: BrandIconProps) {
  return (
    <BrandIcon {...props}>
      <path d="M5.745 1.05c2.852 2.144 5.928 6.483 7.062 8.815C13.94 7.533 17.016 3.194 19.868 1.05 21.926-.453 24 .56 24 2.946c0 .478-.275 4.013-.434 4.59-.567 1.998-2.604 2.503-4.434 2.211 3.235.55 4.061 2.389 2.293 4.226-3.355 3.482-4.83-.873-5.198-1.987-.067-.196-.099-.301-.099-.211 0-.092-.032.015-.099.211-.367 1.114-1.842 5.469-5.198 1.987-1.768-1.835-.941-3.677 2.293-4.226-1.832.292-3.868-.213-4.434-2.211C8.521 6.96 8.246 3.424 8.246 2.946c0-2.385 2.073-3.4 5.084-1.897" />
    </BrandIcon>
  )
}
