...
const STEPS = [
  {
    ...
    body: "Maya raised funding on a crowdfunding app — her project page, updates, and supporters were saved to her Certified account automatically.",
  },
  {
    num: "02",
    title: "Her record speaks for her",
    body: "A foundation she's never met finds her on Certified, sees her completed work and who vouched for it, and reaches out.",
  },
  {
    num: "03",
