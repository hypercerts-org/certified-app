...
const STEPS = [
  ...
  },
  {
    ...
    body: "A monitoring partner attaches independent evidence to her record — bioacoustic analytics of the recovering watershed. A foundation she's never met finds her on Certified, sees the work and the proof behind it, and reaches out.",
  },
  {
    num: "03",
