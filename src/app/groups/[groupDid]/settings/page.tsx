...
import type { OrgMember, AuditEntry, OrgRole } from "@/lib/groups/types"
...
export default function OrgSettingsPage() {
  ...
  const backUrl = `/groups/${encodeURIComponent(groupDid)}`

  return (
    <div className="dashboard">
      <div className="dashboard__topbar">
        <h1 className="dashboard__page-title">Group Settings</h1>
        ...
        <div className="dashboard__main">
          ...
          <div className="dash-card">
            ...
            <p className="dash-card__desc">
              The group&apos;s handle on the network.
            </p>
