    ...
    <div className="dashboard">
      <div className="dashboard__topbar">
        <h1 className="dashboard__page-title">
          {profile?.displayName || org?.displayName || "Organization"}
        </h1>
                ...
                {canEdit && (
                  <div className="mt-4">
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        router.push(`/organizations/${encodeURIComponent(groupDid)}/edit-profile`)
                      }
                    >
                      <Edit3 size={14} />
                      Edit Profile
              ...
              <div className="dash-card">
                ...
                <div className="org-manage__actions">
                  <Button
                    variant="ghost"
                    onClick={() =>
                      router.push(`/organizations/${encodeURIComponent(groupDid)}/apps`)
                    }
                  >
                    Apps
                  </Button>
                  <Button
                    variant="ghost"
                    onClick={() =>
                      router.push(`/organizations/${encodeURIComponent(groupDid)}/settings`)
                    }
                  >
                    Settings
                  </Button>
